...
public class Indexador {
     ...
     */
    public static String DIR_LIBROS = File.separator 
     ...
     *  Se debe cambiar si la ubicacion es diferente.
     */
    public static String DIR_LISTAS_LIBROS = "aplicaciones" + File.separator
     ...
     */
    public final static String SEPARADORES = "[[ ]*|[,]*|[\\.]*|[\t]*|[:]*|[;]*|[(]*|[)]*|[/]*|[!]*|[?]*|[¿]*|[“]*|[�?]*|[+]*]+";

    /** TALLA_VOCABULARIO contiene una estimacion del numero de terminos a tratar.
     *  Debe cambiarse si procede.
     */
    public final static int TALLA_VOCABULARIO = 120000;
    ...
    private Map<String, ListaConPI<Indice>> indices;
            ...
            while (libro.hasNext()) {
                ...
                for (int i = 0; i < words.length; i++) {
                    ...
                    if (esTermino(clave)) {
                        ...
                        ListaConPI<Indice> palEnHash = indices.recuperar(clave);
                        
                        if(palEnHash == null){
                            ListaConPI<Indice> pal= new LEGListaConPI<Indice>();
                            pal.insertar(ind);
                            indices.insertar(clave, pal);
                        } else{
    ...
    public ListaConPI<String> indiceDe(String pal) {
        ...
        // COMPLETAR
        ListaConPI<Indice> aux = indices.recuperar(pal);
        if(aux != null){
            res.inicio();
     ...
     */
    public static boolean esTermino(String s) {

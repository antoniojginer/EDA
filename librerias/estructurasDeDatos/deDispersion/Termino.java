...
public class Termino {
    ...
    private int hashSimple() { 
        ...
        int longitud = termino.length();
        
        for(int i = 0; i<longitud; i++){
            res += termino.codePointAt(i);
        }
        return res;
    }
    ...
    private int hashWeiss() { 
        ...
        for(int i = longitud-1; i >= 0; i--){
            res += termino.codePointAt(i) * TreintaySiete;
            TreintaySiete *= 37;
        }
        return res;
    }
    ...
    private int hashMcKenzie() { 
        ...
        for(int i = longitud -1 ; i >= 0; i--){
            res += termino.codePointAt(i) * cuatro;
            cuatro *= 4;
        }
        return res;
    }
    ...
    public boolean equals(Object o) {
        ...
        if(o instanceof Termino){
            ...
            if(termino.compareTo(aux.termino) == 0 && fHash == aux.fHash){
                return true;
            }
        }
        return false;

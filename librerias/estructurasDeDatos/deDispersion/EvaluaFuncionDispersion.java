...
import aplicaciones.biblioteca.Indexador;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (fdis = 0; fdis < Termino.NOMFDIS.length; fdis++) {  
                ...
                //COMPLETAR
                TablaHash<Termino, Termino> lista = construirTabla("lista10.txt", fdis);                
                //2.- Mostrar por pantalla los valores de factor de carga y desviacion tipica

                //COMPLETAR  
                
                double desv = lista.desviacionTipica();
                double fact = lista.factorCarga();
                
                System.out.println("Factor Carga: " + fact + "\nDesviacion Tipica: " + desv + "\n");
